...
先选择一个**导出用途**：**网页 / YouTube**（MP4，1080p，60 fps）、**社交媒体**（同样的画面，30 fps，文件大小减半）、**工作室**（按录制原始分辨率导出的 MP4，60 fps）或 **README GIF**（480p、15 fps 的 GIF）。导出用途不会改变项目的画面比例。以下所有设置都在**高级**中。
