...
先選擇一個**匯出用途**：**網頁 / YouTube**（MP4，1080p，60 fps）、**社群媒體**（同樣的畫面，30 fps，檔案大小減半）、**工作室**（以錄製原始解析度匯出的 MP4，60 fps）或 **README GIF**（480p、15 fps 的 GIF）。匯出用途不會改變專案的畫面比例。以下所有設定都在**進階**中。
